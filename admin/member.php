...
<header class="text-black-600  " id="header">
    <div class=" rounded-lg  bg-gray-900  container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center text-bold bg-black ">
        ...
        <div class="rounded-lg  p-1  m-1 w-5/6 mx-auto bg-gray-200 text-gray-800">
          <p class="text-4xl text-left font-bold m-3">Members</p>
        </div>  
          <table class="rounded-lg  w-5/6 mx-auto bg-gray-200 text-gray-800">
            ...
            <?php
                  ...
                  <td  class=" text-center"><?php echo $row['id']; ?></td>
                    ...
                    <td  class=" text-center"><a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank">
                ...
                <td  class=" text-center"><a href="deletemember.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-trash"></i></a></td>
