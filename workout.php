...
<header class="text-black-600 body-font-black  bg-black   " id="header">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center text-bold bg-black ">
        ...
        <a href="#" class="inline-flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg  ">Member!</a>
    </div>
</header>

<section class="text-gray-600 body-font bg-gray-300  " id="workout">
    <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
        <h1 class="text-3xl font-medium title-font mb-4 text-gray-900 tracking-widest">Work<button class="py-1 px-4 bg-red-500 text-white focus:outline-none">OUT</button></h1>
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base  ">Please watch the video carefully🧐</p>
    </div>
    ...
    <div class="lg:w-1/3 sm:w-1/2 p-4">
        ...
        <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-gray-100 opacity-0 hover:opacity-50">
            <h2 class="tracking-widest text-sm title-font font-medium text-red-500 mb-1"><?php echo $row["workout"]; ?></h2>
